...
import pe.com.transaltisa.reportedefallas.Activities.LoginActivity;
...
public class SessionManager {
	...
	public void createLoginSession(String name, String email, String id){
		...
		//Storing id
		editor.putString(ID_INSPECTOR, id);
		// commit changes
		editor.commit();
	}	
	...
	public HashMap<String, String> getUserDetails(){
		...
		// id inspector
		user.put(ID_INSPECTOR, pref.getString(ID_INSPECTOR, null));
